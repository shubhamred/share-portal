...
const mapStateToProps = ({ brandReducer }) => {
  const operatingSectorsValue = (brandReducer.formData.data
    && brandReducer.formData.data.brandBusinessCategory
    && formatOtherArray(
      brandReducer.formData.data.brandBusinessCategory,
  ...
  return {
    ...
    initialValues: {
      ...
      dateOfIncorportation:
        brandReducer.formData.data.incorporationDate
      ...
      numberOfDirectors:
        brandReducer.applicantList && brandReducer.applicantList.length,
