...
import ApplicantBasicInfoForm from '../../../../brands/brandDetail/forms/applicant/components/applicantForm';
...
const ApplicantInfo = ({ selectedApplicant, companyId }) => {
  ...
  return (
    <div>
      ...
      {selectedTab === 'number' && (
        <NumberTabContent resourceId={selectedApplicant.id} />
      )}
      {selectedTab === 'email' && (
        <EmailTabContent resourceId={selectedApplicant.id} />
      )}
      {selectedTab === 'address' && (
        <AddressTabContent resourceId={selectedApplicant.id} />
      )}
    </div>
  );
};
