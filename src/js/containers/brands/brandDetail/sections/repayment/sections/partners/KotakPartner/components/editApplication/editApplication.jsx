...
const EditApplication = (props) => {
  const { handleSubmit, onClose, brandId, change, onSubmit, initialValues } = props;
  const [applicationList, setApplicationList] = useState([]);
  const [selectedApplication, setApplicationCode] = useState(initialValues?.applicationCode);
  const [selectedSources, setSelectedSources] = useState(initialValues?.revenueSource || []);
