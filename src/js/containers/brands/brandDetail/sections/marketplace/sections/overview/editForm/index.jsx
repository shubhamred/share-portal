...
const PatronForm = (props) => {
  ...
  const onSubmitHandler = () => {
    const payload = {
      marketplace_account_type: accountType,
      marketplace_accouunt_number: accountNumber,
      marketplace_account_name: accountName
    };
    onSubmit(payload);
  };
    ...
    <Grid item={true} container={true} direction="column" style={{ minWidth: '700px' }}>
      <Grid container={true} sm={12}>
        <Grid item={true} sm={6} className={styles.inputGap}>
          <p className={styles.inputHeading}>Marketplace account type</p>
          <Grid sm={11}>
        ...
        <Grid item={true} sm={6} className={styles.inputGap}>
          <p className={styles.inputHeading}>Marketplace account name</p>
          <Grid sm={11}>
            <FormControl variant="outlined" className={styles.formControl}>
              <Input
                className={styles.inputHeight}
        ...
        <Grid item={true} sm={6} className={styles.inputGap}>
          <p className={styles.inputHeading}>Marketplace account number</p>
          <Grid sm={11}>
            <FormControl variant="outlined" className={styles.formControl}>
              <Input
                className={styles.inputHeight}
