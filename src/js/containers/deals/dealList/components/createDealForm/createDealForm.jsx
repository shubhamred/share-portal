...
import { AutocompleteCustom, Button, DropDown, Input, Switch } from 'app/components';
...
const CloneDealForm = (props) => {
  ...
  const BRAND = {
    businessName: deal.brandName || '',
    id: deal.brandId,
    companyCode: deal.brandCode || '',
    companyLogo: deal.brandLogo || ''
  };
  ...
  const handleFormSubmit = (values) => {
    ...
    onSubmit({
      ...
      applicationData: applicationList.find((list) => list.key === selectedApplication)
    });
  };
    ...
    <Grid container={true}>
      <form className={styles.form} onSubmit={handleSubmit(handleFormSubmit)}>
        ...
        <div className={styles.buttonStyle}>
          <Button type="submit" label="Create Deal" />
        </div>
      </form>
    </Grid>
  );
